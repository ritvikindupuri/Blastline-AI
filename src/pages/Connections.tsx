      ...
      <div className="space-y-6 max-w-5xl">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Connect an AWS account using an IAM user's access key + secret. Vaultline only needs read-only permissions to audit your posture.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card/60 backdrop-blur p-6 space-y-5 shadow-card">
          <div className="flex items-center gap-2 text-primary">
            ...
            <h3 className="font-display font-semibold">Create a Vaultline IAM user in AWS</h3>
          </div>
          ...
          <ol className="space-y-4 text-sm leading-relaxed">
            ...
            <li>
              <span className="font-mono text-primary">[2]</span> Name the user <span className="font-mono text-foreground">vaultline-auditor</span>. Leave “Provide user access to the AWS Management Console” <span className="font-mono text-foreground">unchecked</span>. Click <span className="font-mono text-foreground">Next</span>.
            </li>
            <li>
              ...
              <div className="text-xs text-muted-foreground mt-2">Both are read-only. Vaultline cannot modify, create, or delete anything in your account.</div>
            </li>
            <li>
